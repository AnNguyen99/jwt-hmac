...
import com.mycompany.myapp.service.dto.ManagedUserDTO;
...
class UserResourceIT {
    ...
    void createUser() throws Exception {
        ...
        restUserMockMvc
            .perform(
                post("/api/admin/users").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(managedUserDTO))
            )
    ...
    void updateUser() throws Exception {
        ...
        restUserMockMvc
            .perform(
                put("/api/admin/users").contentType(MediaType.APPLICATION_JSON).content(TestUtil.convertObjectToJsonBytes(managedUserDTO))
            )
            .andExpect(status().isOk());
    ...
    void updateUserExistingEmail() throws Exception {
        ...
        managedUserDTO.setId(updatedUser.getId());
        managedUserDTO.setLogin(updatedUser.getLogin());
        managedUserDTO.setPassword(updatedUser.getPassword());
        managedUserDTO.setFirstName(updatedUser.getFirstName());
        managedUserDTO.setLastName(updatedUser.getLastName());
        managedUserDTO.setEmail("jhipster@localhost"); // this email should already be used by anotherUser
        managedUserDTO.setActivated(updatedUser.isActivated());
        managedUserDTO.setImageUrl(updatedUser.getImageUrl());
        managedUserDTO.setLangKey(updatedUser.getLangKey());
        managedUserDTO.setCreatedBy(updatedUser.getCreatedBy());
        managedUserDTO.setCreatedDate(updatedUser.getCreatedDate());
        managedUserDTO.setLastModifiedBy(updatedUser.getLastModifiedBy());
        managedUserDTO.setLastModifiedDate(updatedUser.getLastModifiedDate());
    ...
    void updateUserExistingLogin() throws Exception {
        ...
        managedUserDTO.setFirstName(updatedUser.getFirstName());
        managedUserDTO.setLastName(updatedUser.getLastName());
        managedUserDTO.setEmail(updatedUser.getEmail());
        managedUserDTO.setActivated(updatedUser.isActivated());
        managedUserDTO.setImageUrl(updatedUser.getImageUrl());
        managedUserDTO.setLangKey(updatedUser.getLangKey());
        managedUserDTO.setCreatedBy(updatedUser.getCreatedBy());
