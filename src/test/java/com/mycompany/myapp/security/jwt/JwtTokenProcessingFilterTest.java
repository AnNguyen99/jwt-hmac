...
class JwtTokenProcessingFilterTest {
    ...
    public void setup() {
        ...
        jwtTokenProcessingFilter = new JwtTokenProcessingFilter(tokenProvider);
    ...
    void testJWTFilter() throws Exception {
        ...
        request.addHeader(JwtTokenProcessingFilter.AUTHORIZATION_HEADER, "Bearer " + jwt);
        request.setRequestURI("/api/test");
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain filterChain = new MockFilterChain();
        jwtTokenProcessingFilter.doFilter(request, response, filterChain);
    ...
    void testJWTFilterMissingToken() throws Exception {
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader(JwtTokenProcessingFilter.AUTHORIZATION_HEADER, "Bearer ");
        request.setRequestURI("/api/test");
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain filterChain = new MockFilterChain();
        jwtTokenProcessingFilter.doFilter(request, response, filterChain);
    ...
    void testJWTFilterWrongScheme() throws Exception {
        ...
        String jwt = tokenProvider.createToken(authentication, false);
        MockHttpServletRequest request = new MockHttpServletRequest();
        request.addHeader(JwtTokenProcessingFilter.AUTHORIZATION_HEADER, "Basic " + jwt);
        request.setRequestURI("/api/test");
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain filterChain = new MockFilterChain();
        jwtTokenProcessingFilter.doFilter(request, response, filterChain);
